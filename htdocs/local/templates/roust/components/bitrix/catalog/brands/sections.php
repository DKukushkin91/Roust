...
<section class="brands">
	<div class="container brands__container">
		...
		<div class="brands__wrap js-list-wrap">
		...
		<li class="brands__item brands__item--flex">
			...
			<div class="brands__item-content brands__item-content--max-width">
				...
				<p class="brands__item-text">Our portfolio of Russian vodkas includes some of the best known and most loved
					brands in Russia, and 86 countries across the world.</p><a class="brands__link animate-button" href="/brands/owned/russian-vodka/"><span
		...
		<li class="brands__item brands__item--grid-2">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">Founded in 1850, Gancia is the creator of the first Italian sparkling wine.</p><a
					class="brands__link animate-button" href="/brands/owned/sparkling-wines/"><span class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">Darrow is Roust Group’s first owned whisky brand. It is produced and bottled in one
					of Scotland's finest distilleries.</p><a class="brands__link animate-button" href="/brands/owned/whisky/"><span
						class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item brands__item--grid-3 brands__item--bg-blue">
			...
			<div class="brands__item-content brands__item-content--max-width">
				...
				<p class="brands__item-text">Our Ready-to-Drink business is a category leader in Russia, producing well-known
					...
					class="brands__link animate-button" href="/brands/owned/ready-to-drink/"><span class="brands__link-text">More</span></a>
			</div>
		</li>
	...
	<ul class="brands__list js-brands-list">
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<a class="brands__link animate-button" href="/brands/distributed/whisky/"><span class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">One of the few cognac houses that produces the world's most prestigious Fine
					Champagne cognac.</p><a class="brands__link animate-button" href="/brands/distributed/cognac-and-brandy/"><span
						class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item">
		...
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">For 40 years, Carlo Rossi has kept its simple, straightforward approach to
					...
					class="brands__link animate-button" href="/brands/distributed/wines/"><span class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">The oldest rum in the world and the symbol of the island of Barbados.</p><a
					class="brands__link animate-button" href="/brands/distributed/rum/"><span class="brands__link-text">More</span></a>
			</div>
		</li>
		<li class="brands__item">
			...
			<div class="brands__item-content">
				...
				<p class="brands__item-text">Tequila Sierra, with its famous sombrero cap, is in great demand not only in its
					homeland, Mexico, but also far beyond its borders.</p><a class="brands__link animate-button" href="/brands/distributed/tequila/"><span
						class="brands__link-text">More</span></a>
			</div>
		</li>
